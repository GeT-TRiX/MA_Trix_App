...
j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC101111"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC110001"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC110011"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC110101"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC110111"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC111001"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC111011"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC111101"></div>',j+='<div class="number-black" style="position: absolute; left: -1000px; top: -2200px;" id="'+N+'-resultC111111"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" class = "children" id="'+N+'-label1"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" id="'+N+'-label2"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" id="'+N+'-label3"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" id="'+N+'-label4"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" id="'+N+'-label5"></div>',j+='<div style="position: absolute; left: -1000px; top: -1000px; opacity:0.5;" id="'+N+'-label6"></div>',j+="</div>",b.html(j),g=new C2S(e,f),a("*[id^="+N+"-resultC]").each(function(){a(this).html(0),a(this).addClass("number-empty"),a(this).css("font-size",d.fontSize),a(this).css("font-family",d.fontFamily)}),a("*[id^="+N+"-label]").each(function(){a(this).css("font-family",d.fontFamily)}),a("*[id^="+N+"-label]").each(function(){a(this).css("font-size",d.fontSize)});var k=H();"list"==k[0]?C():"count"==k[0]&&G(),null!=d.searchInput&&d.searchInput.keyup(function(){M(d.searchInput.val(),d.searchMinSize)}),"edwards"==d.displayMode?A(k[1]):z(k[1]),d.displayStat&&w(k[1]),d.exporting===!0&&J(b,c,k[0]),d.displaySwitch===!0&&k[1]>=4&&B(b,k[1]),a("*[id^="+N+"-resultC]").hover(function(){var b=!1;a("*[id^="+N+"-item]").each(function(){"on"===a(this).children("span").text()&&(b=!0)});var c=!1;if(null!=d.searchInput&&""!=d.searchInput.val()&&(c=!0),!b&&!c&&""!==a(this).text()){var e=this.listnames,f=this;a("*[id^="+N+"-label]").each(function(){e.indexOf(a(this).text())<0?a(this).css("opacity",.1):a(this).css("opacity",.6)}),a("*[id^="+N+"-resultC]").each(function(){this!=f&&a(this).css("opacity",.1)}),v(),"edwards"==d.displayMode?A(k[1]):z(k[1]),d.displayStat&&w(k[1])}},function(){var b=!1;a("*[id^="+N+"-item]").each(function(){"on"===a(this).children("span").text()&&(b=!0)});var c=!1;if(null!=d.searchInput&&""!=d.searchInput.val()&&(c=!0),!b&&!c&&""!==a(this).text()){this.listnames;a("*[id^="+N+"-label]").each(function(){a(this).css("opacity",.5)}),a("*[id^="+N+"-resultC]").each(function(){a(this).css("opacity",1)}),v(),"edwards"==d.displayMode?A(k[1]):z(k[1]),d.displayStat&&w(k[1])}}),a("#"+N+"-canvasEllipse").html(g.getSvg())}),this}}(jQuery);
